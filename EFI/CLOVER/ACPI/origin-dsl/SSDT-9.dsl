 ...
 *
 * Disassembly of ../origin/SSDT-9.aml, Mon Dec 14 23:27:33 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001FF3 (8179)
 *     Revision         0x01
 *     Checksum         0xC9
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LASX, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LKDN, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LNKS, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.ECDV.ECNV, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.LPCB.ECDV.GTVR, MethodObj)    // 1 Arguments (from opcode)
    ...
    External (_SB_.PCI0.RP05.DPGE, IntObj)    // (from opcode)
    External (_SB_.PCI0.RP05.NCB7, IntObj)    // (from opcode)
    External (_SB_.PCI0.RP05.PEGP, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.RP05.PEGP.GC6I, MethodObj)    // 0 Arguments (from opcode)
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            ...
            Store (\_SB.PCI0.LREN, LTRS)
            Store (One, \_SB.PCI0.LKDN)
            Store (Zero, Local0)
            While (LLess (Local0, FBTO))
            {
                If (LEqual (\_SB.GGIV (0x04010010), One))
                {
                    Break
                }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            If (LEqual (\_SB.GGIV (0x04010010), One))
            {
                ...
                While (LNotEqual (\_SB.GGIV (0x04010010), Zero))
                {
                    Sleep (One)
                }
        ...
        {
            If (LEqual (\_SB.GGIV (0x04010010), Zero))
            {
                    ...
                    Switch (PSH0)
                    {
                        Case (Zero)
                        {
                            If (CPUT)
                            {
                                Store (0x0200, RETN)
                                Or (RETN, PSH0, RETN)
                                Store (\_SB.PCI0.LPCB.ECDV.GTVR (One), PDTS)
                            }
